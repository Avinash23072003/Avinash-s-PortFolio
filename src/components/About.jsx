...
const About = () => {
  ...
  return (
    <>
      ...
      <div class="ml-20 mt-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 justify-items-center gap-50">
  {services.map((service, index) => (
    <ServiceCard key={service.title} index={index} {...service}  className="gap-16"/>
  ))}
</div>
    </>
  );
